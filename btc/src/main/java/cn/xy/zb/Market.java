...
public class Market {
	...
	public static String[][] arry = new String[21][];
	...
	public static void init(){
		...
		arry[20] = new String[]{"bcw_qc","bcw_usdt","bcw_btc"};
		arry[20] = new String[]{"btp_qc","btp_usdt","btp_btc"};
		arry[20] = new String[]{"bitcny_qc","bitcny_usdt","bitcny_btc"};
