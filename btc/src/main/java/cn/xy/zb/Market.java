...
public class Market {
	...
	public static void init(){
		...
		arry[8] = new String[]{"xrp_qc","xrp_usdt","xrp_btc"};
		arry[9] = new String[]{"bcd_qc","bcd_usdt","bcd_btc"};
		arry[10] = new String[]{"dash_qc","dash_usdt","dash_btc"};
		arry[11] = new String[]{"sbtc_qc","sbtc_usdt","sbtc_btc"};
		arry[12] = new String[]{"ink_qc","ink_usdt","ink_btc"};
		arry[13] = new String[]{"tv_qc","tv_usdt","tv_btc"};
		arry[14] = new String[]{"bcx_qc","bcx_usdt","bcx_btc"};
		arry[15] = new String[]{"bth_qc","bth_usdt","bth_btc"};
		arry[16] = new String[]{"lbtc_qc","lbtc_usdt","lbtc_btc"};
		arry[17] = new String[]{"eos_qc","eos_usdt","eos_btc"};
